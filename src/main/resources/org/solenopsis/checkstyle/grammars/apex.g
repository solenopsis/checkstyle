...
////////////////////////////////////////////////////////////////////////////////
header {
package org.solenopsis.checkstyle.grammars;
 ...
 */
class GeneratedApexRecognizer extends Parser;

options {
    k = 2;                           // two token lookahead
    exportVocab=GeneratedApex;       // Call its vocabulary "GeneratedApex"
...
tokens {
    ...
    LITERAL_null="null";LITERAL_new="new";NUM_INT;
    ...
    LITERAL_with="with";LITERAL_without="without";LITERAL_sharing="sharing";
    LITERAL_global="global";LITERAL_webservice="webservice";
}
...
// The Java scanner
//----------------------------------------------------------------------------
class GeneratedApexLexer extends Lexer;

options {
    exportVocab=GeneratedApex; // call the vocabulary "Java"
