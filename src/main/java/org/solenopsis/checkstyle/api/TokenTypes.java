...
package org.solenopsis.checkstyle.api;

import org.solenopsis.checkstyle.grammars.GeneratedApexTokenTypes;
...
public final class TokenTypes {
     ...
     * @see #INTERFACE_DEF
     **/
    public static final int EOF = GeneratedApexTokenTypes.EOF;
    /**
     ...
     * @see #LITERAL_DEFAULT
     **/
    public static final int MODIFIERS = GeneratedApexTokenTypes.MODIFIERS;
     ...
     * @see #ANNOTATION_DEF
     **/
    public static final int OBJBLOCK = GeneratedApexTokenTypes.OBJBLOCK;
    /**
     ...
     * @see #CASE_GROUP
     **/
    public static final int SLIST = GeneratedApexTokenTypes.SLIST;
    /**
     ...
     * @see #CLASS_DEF
     **/
    public static final int CTOR_DEF = GeneratedApexTokenTypes.CTOR_DEF;
    /**
     ...
     * @see #OBJBLOCK
     **/
    public static final int METHOD_DEF = GeneratedApexTokenTypes.METHOD_DEF;
    /**
    ...
    public static final int VARIABLE_DEF =
        GeneratedApexTokenTypes.VARIABLE_DEF;
    ...
    public static final int INSTANCE_INIT =
        GeneratedApexTokenTypes.INSTANCE_INIT;
    ...
    public static final int STATIC_INIT =
        GeneratedApexTokenTypes.STATIC_INIT;
     ...
     * @see #TYPE_ARGUMENTS
     **/
    public static final int TYPE = GeneratedApexTokenTypes.TYPE;
    /**
     * A class declaration.
     *
     * <p>For example:</p>
     ...
     * @see #LITERAL_NEW
     **/
    public static final int CLASS_DEF = GeneratedApexTokenTypes.CLASS_DEF;
    /**
    ...
    public static final int INTERFACE_DEF =
        GeneratedApexTokenTypes.INTERFACE_DEF;
     ...
     * @see FullIdent
     **/
    public static final int PACKAGE_DEF = GeneratedApexTokenTypes.PACKAGE_DEF;
    /**
    ...
    public static final int ARRAY_DECLARATOR =
        GeneratedApexTokenTypes.ARRAY_DECLARATOR;
    ...
    public static final int EXTENDS_CLAUSE =
        GeneratedApexTokenTypes.EXTENDS_CLAUSE;
    ...
    public static final int IMPLEMENTS_CLAUSE =
        GeneratedApexTokenTypes.IMPLEMENTS_CLAUSE;
     ...
     * @see #CTOR_DEF
     **/
    public static final int PARAMETERS = GeneratedApexTokenTypes.PARAMETERS;
    /**
    ...
    public static final int PARAMETER_DEF =
        GeneratedApexTokenTypes.PARAMETER_DEF;
    ...
    public static final int LABELED_STAT =
        GeneratedApexTokenTypes.LABELED_STAT;
     ...
     * @see #RPAREN
     **/
    public static final int TYPECAST = GeneratedApexTokenTypes.TYPECAST;
    /**
     ...
     * @see #EXPR
     **/
    public static final int INDEX_OP = GeneratedApexTokenTypes.INDEX_OP;
    /**
     ...
     * @see #INC
     **/
    public static final int POST_INC = GeneratedApexTokenTypes.POST_INC;
    /**
     ...
     * @see #DEC
     **/
    public static final int POST_DEC = GeneratedApexTokenTypes.POST_DEC;
    /**
     ...
     * @see FullIdent
     **/
    public static final int METHOD_CALL = GeneratedApexTokenTypes.METHOD_CALL;

    /**
     * Part of Java 8 syntax. Method or constructor call without arguments.
     * @see #DOUBLE_COLON
     */
    public static final int METHOD_REF = GeneratedApexTokenTypes.METHOD_REF;
    /**
     ...
     * @see #RPAREN
     **/
    public static final int EXPR = GeneratedApexTokenTypes.EXPR;
    /**
     ...
     * @see #COMMA
     **/
    public static final int ARRAY_INIT = GeneratedApexTokenTypes.ARRAY_INIT;
    /**
     ...
     * @see FullIdent
     **/
    public static final int IMPORT = GeneratedApexTokenTypes.IMPORT;
    /**
     ...
     * @see #EXPR
     **/
    public static final int UNARY_MINUS = GeneratedApexTokenTypes.UNARY_MINUS;
    /**
     ...
     * @see #EXPR
     **/
    public static final int UNARY_PLUS = GeneratedApexTokenTypes.UNARY_PLUS;
    /**
     ...
     * @see #LITERAL_SWITCH
     **/
    public static final int CASE_GROUP = GeneratedApexTokenTypes.CASE_GROUP;
    /**
     ...
     * @see #SUPER_CTOR_CALL
     **/
    public static final int ELIST = GeneratedApexTokenTypes.ELIST;
    /**
     ...
     * @see #LITERAL_FOR
     **/
    public static final int FOR_INIT = GeneratedApexTokenTypes.FOR_INIT;
    /**
    ...
    public static final int FOR_CONDITION =
        GeneratedApexTokenTypes.FOR_CONDITION;
    ...
    public static final int FOR_ITERATOR =
        GeneratedApexTokenTypes.FOR_ITERATOR;
     ...
     * @see #LITERAL_WHILE
     **/
    public static final int EMPTY_STAT = GeneratedApexTokenTypes.EMPTY_STAT;
    /**
     * The <code>final</code> keyword.
     *
     * @see #MODIFIERS
     **/
    public static final int FINAL = GeneratedApexTokenTypes.FINAL;
    /**
     * The <code>abstract</code> keyword.
     *
     * @see #MODIFIERS
     **/
    public static final int ABSTRACT = GeneratedApexTokenTypes.ABSTRACT;
    /**
     * The <code>strictfp</code> keyword.
     *
     * @see #MODIFIERS
     **/
    public static final int STRICTFP = GeneratedApexTokenTypes.STRICTFP;
    /**
    ...
    public static final int SUPER_CTOR_CALL =
        GeneratedApexTokenTypes.SUPER_CTOR_CALL;
     ...
     * @see #SUPER_CTOR_CALL
     **/
    public static final int CTOR_CALL = GeneratedApexTokenTypes.CTOR_CALL;
     ...
     * @see #LITERAL_FOR
     **/
    public static final int SEMI = GeneratedApexTokenTypes.SEMI;
     ...
     * @see #ARRAY_DECLARATOR
     **/
    public static final int RBRACK = GeneratedApexTokenTypes.RBRACK;
    /**
    ...
    public static final int LITERAL_VOID =
        GeneratedApexTokenTypes.LITERAL_void;
    ...
    public static final int LITERAL_BOOLEAN =
        GeneratedApexTokenTypes.LITERAL_boolean;
    ...
    public static final int LITERAL_BYTE =
        GeneratedApexTokenTypes.LITERAL_byte;
    ...
    public static final int LITERAL_CHAR =
        GeneratedApexTokenTypes.LITERAL_char;
    ...
    public static final int LITERAL_SHORT =
        GeneratedApexTokenTypes.LITERAL_short;
     ...
     * @see #TYPE
     **/
    public static final int LITERAL_INT = GeneratedApexTokenTypes.LITERAL_int;
    /**
    ...
    public static final int LITERAL_FLOAT =
        GeneratedApexTokenTypes.LITERAL_float;
    ...
    public static final int LITERAL_LONG =
        GeneratedApexTokenTypes.LITERAL_long;
    ...
    public static final int LITERAL_DOUBLE =
        GeneratedApexTokenTypes.LITERAL_double;

    /**
     * An identifier.  These can be names of types, subpackages,
     * fields, methods, parameters, and local variables.
     **/
    public static final int IDENT = GeneratedApexTokenTypes.IDENT;
    /**
     * The <code>&#46;</code> (dot) operator.
     *
     * @see FullIdent
     **/
    public static final int DOT = GeneratedApexTokenTypes.DOT;
    /**
     ...
     * @see #IMPORT
     **/
    public static final int STAR = GeneratedApexTokenTypes.STAR;
    /**
    ...
    public static final int LITERAL_PRIVATE =
        GeneratedApexTokenTypes.LITERAL_private;
    ...
    public static final int LITERAL_PUBLIC =
        GeneratedApexTokenTypes.LITERAL_public;
    ...
    public static final int LITERAL_PROTECTED =
        GeneratedApexTokenTypes.LITERAL_protected;
    ...
    public static final int LITERAL_STATIC =
        GeneratedApexTokenTypes.LITERAL_static;
    ...
    public static final int LITERAL_TRANSIENT =
        GeneratedApexTokenTypes.LITERAL_transient;
    ...
    public static final int LITERAL_NATIVE =
        GeneratedApexTokenTypes.LITERAL_native;
    ...
    public static final int LITERAL_SYNCHRONIZED =
        GeneratedApexTokenTypes.LITERAL_synchronized;
    ...
    public static final int LITERAL_VOLATILE =
        GeneratedApexTokenTypes.LITERAL_volatile;
    ...
    public static final int LITERAL_CLASS =
        GeneratedApexTokenTypes.LITERAL_class;
    ...
    public static final int LITERAL_INTERFACE =
        GeneratedApexTokenTypes.LITERAL_interface;
     ...
     * @see #SLIST
     **/
    public static final int LCURLY = GeneratedApexTokenTypes.LCURLY;
    /**
     ...
     * @see #SLIST
     **/
    public static final int RCURLY = GeneratedApexTokenTypes.RCURLY;
    /**
     ...
     * @see #IMPLEMENTS_CLAUSE
     **/
    public static final int COMMA = GeneratedApexTokenTypes.COMMA;
     ...
     * @see #LITERAL_CATCH
     **/
    public static final int LPAREN = GeneratedApexTokenTypes.LPAREN;
    /**
     ...
     * @see #LITERAL_CATCH
     **/
    public static final int RPAREN = GeneratedApexTokenTypes.RPAREN;
    /**
    ...
    public static final int LITERAL_THIS =
        GeneratedApexTokenTypes.LITERAL_this;
    ...
    public static final int LITERAL_SUPER =
        GeneratedApexTokenTypes.LITERAL_super;
     ...
     * @see #EXPR
     **/
    public static final int ASSIGN = GeneratedApexTokenTypes.ASSIGN;
    /**
    ...
    public static final int LITERAL_THROWS =
        GeneratedApexTokenTypes.LITERAL_throws;
     ...
     * @see #CASE_GROUP
     **/
    public static final int COLON = GeneratedApexTokenTypes.COLON;
     ...
     * @see #METHOD_REF
     */
    public static final int DOUBLE_COLON = GeneratedApexTokenTypes.DOUBLE_COLON;
    /**
     ...
     * @see #LITERAL_ELSE
     **/
    public static final int LITERAL_IF = GeneratedApexTokenTypes.LITERAL_if;
    /**
     ...
     * @see #EXPR
     **/
    public static final int LITERAL_FOR = GeneratedApexTokenTypes.LITERAL_for;
    /**
    ...
    public static final int LITERAL_WHILE =
        GeneratedApexTokenTypes.LITERAL_while;
     ...
     * @see #SEMI
     **/
    public static final int LITERAL_DO = GeneratedApexTokenTypes.LITERAL_do;
    /**
     * Literal <code>while</code> in do-while loop.
     * @see #LITERAL_DO
     */
    public static final int DO_WHILE = GeneratedApexTokenTypes.DO_WHILE;
    /**
    ...
    public static final int LITERAL_BREAK =
        GeneratedApexTokenTypes.LITERAL_break;
    ...
    public static final int LITERAL_CONTINUE =
        GeneratedApexTokenTypes.LITERAL_continue;
    ...
    public static final int LITERAL_RETURN =
        GeneratedApexTokenTypes.LITERAL_return;
    ...
    public static final int LITERAL_SWITCH =
        GeneratedApexTokenTypes.LITERAL_switch;
    ...
    public static final int LITERAL_THROW =
        GeneratedApexTokenTypes.LITERAL_throw;
    ...
    public static final int LITERAL_ELSE =
        GeneratedApexTokenTypes.LITERAL_else;
    ...
    public static final int LITERAL_CASE =
        GeneratedApexTokenTypes.LITERAL_case;
    ...
    public static final int LITERAL_DEFAULT =
        GeneratedApexTokenTypes.LITERAL_default;
     ...
     * @see #LITERAL_FINALLY
     **/
    public static final int LITERAL_TRY = GeneratedApexTokenTypes.LITERAL_try;
    ...
    public static final int RESOURCE_SPECIFICATION =
        GeneratedApexTokenTypes.RESOURCE_SPECIFICATION;
    ...
    public static final int RESOURCES =
        GeneratedApexTokenTypes.RESOURCES;
    ...
    public static final int RESOURCE =
        GeneratedApexTokenTypes.RESOURCE;
    ...
    public static final int LITERAL_CATCH =
        GeneratedApexTokenTypes.LITERAL_catch;
    ...
    public static final int LITERAL_FINALLY =
        GeneratedApexTokenTypes.LITERAL_finally;
     ...
     * @see #EXPR
     **/
    public static final int PLUS_ASSIGN = GeneratedApexTokenTypes.PLUS_ASSIGN;
    /**
    ...
    public static final int MINUS_ASSIGN =
        GeneratedApexTokenTypes.MINUS_ASSIGN;
     ...
     * @see #EXPR
     **/
    public static final int STAR_ASSIGN = GeneratedApexTokenTypes.STAR_ASSIGN;
    /**
     ...
     * @see #EXPR
     **/
    public static final int DIV_ASSIGN = GeneratedApexTokenTypes.DIV_ASSIGN;
    /**
     ...
     * @see #EXPR
     **/
    public static final int MOD_ASSIGN = GeneratedApexTokenTypes.MOD_ASSIGN;
    /**
     ...
     * @see #EXPR
     **/
    public static final int SR_ASSIGN = GeneratedApexTokenTypes.SR_ASSIGN;
    /**
     ...
     * @see #EXPR
     **/
    public static final int BSR_ASSIGN = GeneratedApexTokenTypes.BSR_ASSIGN;
    /**
     ...
     * @see #EXPR
     **/
    public static final int SL_ASSIGN = GeneratedApexTokenTypes.SL_ASSIGN;
    /**
     ...
     * @see #EXPR
     **/
    public static final int BAND_ASSIGN = GeneratedApexTokenTypes.BAND_ASSIGN;
    /**
     ...
     * @see #EXPR
     **/
    public static final int BXOR_ASSIGN = GeneratedApexTokenTypes.BXOR_ASSIGN;
    /**
     ...
     * @see #EXPR
     **/
    public static final int BOR_ASSIGN = GeneratedApexTokenTypes.BOR_ASSIGN;
    /**
     ...
     * @see #COLON
     **/
    public static final int QUESTION = GeneratedApexTokenTypes.QUESTION;
    /**
     ...
     * @see #EXPR
     **/
    public static final int LOR = GeneratedApexTokenTypes.LOR;
    /**
     ...
     * @see #EXPR
     **/
    public static final int LAND = GeneratedApexTokenTypes.LAND;
    /**
     ...
     * @see #EXPR
     **/
    public static final int BOR = GeneratedApexTokenTypes.BOR;
    /**
     ...
     * @see #EXPR
     **/
    public static final int BXOR = GeneratedApexTokenTypes.BXOR;
    /**
     ...
     * @see #EXPR
     **/
    public static final int BAND = GeneratedApexTokenTypes.BAND;
    /**
     * The <code>&#33;=</code> (not equal) operator.
     *
     * @see #EXPR
     **/
    public static final int NOT_EQUAL = GeneratedApexTokenTypes.NOT_EQUAL;
    /**
     * The <code>==</code> (equal) operator.
     *
     * @see #EXPR
     **/
    public static final int EQUAL = GeneratedApexTokenTypes.EQUAL;
    /**
     * The <code>&lt;</code> (less than) operator.
     *
     * @see #EXPR
     **/
    public static final int LT = GeneratedApexTokenTypes.LT;
    /**
     * The <code>&gt;</code> (greater than) operator.
     *
     * @see #EXPR
     **/
    public static final int GT = GeneratedApexTokenTypes.GT;
    /**
     * The <code>&lt;=</code> (less than or equal) operator.
     *
     * @see #EXPR
     **/
    public static final int LE = GeneratedApexTokenTypes.LE;
    /**
     * The <code>&gt;=</code> (greater than or equal) operator.
     *
     * @see #EXPR
     **/
    public static final int GE = GeneratedApexTokenTypes.GE;
    /**
    ...
    public static final int LITERAL_INSTANCEOF =
        GeneratedApexTokenTypes.LITERAL_instanceof;
     ...
     * @see #EXPR
     **/
    public static final int SL = GeneratedApexTokenTypes.SL;
    /**
     ...
     * @see #EXPR
     **/
    public static final int SR = GeneratedApexTokenTypes.SR;
    /**
     ...
     * @see #EXPR
     **/
    public static final int BSR = GeneratedApexTokenTypes.BSR;
    /**
     ...
     * @see #EXPR
     **/
    public static final int PLUS = GeneratedApexTokenTypes.PLUS;
    /**
     ...
     * @see #EXPR
     **/
    public static final int MINUS = GeneratedApexTokenTypes.MINUS;
    /**
     ...
     * @see #EXPR
     **/
    public static final int DIV = GeneratedApexTokenTypes.DIV;
    /**
     ...
     * @see #EXPR
     **/
    public static final int MOD = GeneratedApexTokenTypes.MOD;
    /**
     ...
     * @see #POST_INC
     **/
    public static final int INC = GeneratedApexTokenTypes.INC;
    /**
     ...
     * @see #POST_DEC
     **/
    public static final int DEC = GeneratedApexTokenTypes.DEC;
    /**
     ...
     * @see #EXPR
     **/
    public static final int BNOT = GeneratedApexTokenTypes.BNOT;
    /**
     ...
     * @see #EXPR
     **/
    public static final int LNOT = GeneratedApexTokenTypes.LNOT;
    /**
    ...
    public static final int LITERAL_TRUE =
        GeneratedApexTokenTypes.LITERAL_true;
    ...
    public static final int LITERAL_FALSE =
        GeneratedApexTokenTypes.LITERAL_false;
    ...
    public static final int LITERAL_NULL =
        GeneratedApexTokenTypes.LITERAL_null;
     ...
     * @see FullIdent
     **/
    public static final int LITERAL_NEW = GeneratedApexTokenTypes.LITERAL_new;
    /**
     ...
     * @see #NUM_LONG
     **/
    public static final int NUM_INT = GeneratedApexTokenTypes.NUM_INT;
    ...
    public static final int STRING_LITERAL =
        GeneratedApexTokenTypes.STRING_LITERAL;
     ...
     * @see #NUM_DOUBLE
     **/
    public static final int NUM_FLOAT = GeneratedApexTokenTypes.NUM_FLOAT;
    /**
     ...
     * @see #NUM_INT
     **/
    public static final int NUM_LONG = GeneratedApexTokenTypes.NUM_LONG;
    /**
     ...
     * @see #NUM_FLOAT
     **/
    public static final int NUM_DOUBLE = GeneratedApexTokenTypes.NUM_DOUBLE;
     ...
     * </pre>
     **/
    public static final int LITERAL_ASSERT = GeneratedApexTokenTypes.ASSERT;
    ...
    public static final int STATIC_IMPORT =
        GeneratedApexTokenTypes.STATIC_IMPORT;
    ...
    public static final int ENUM_DEF =
        GeneratedApexTokenTypes.ENUM_DEF;
    ...
    public static final int ENUM_CONSTANT_DEF =
        GeneratedApexTokenTypes.ENUM_CONSTANT_DEF;
    ...
    public static final int FOR_EACH_CLAUSE =
        GeneratedApexTokenTypes.FOR_EACH_CLAUSE;
    ...
    public static final int ANNOTATION_DEF =
        GeneratedApexTokenTypes.ANNOTATION_DEF;
    ...
    public static final int ANNOTATION_FIELD_DEF =
        GeneratedApexTokenTypes.ANNOTATION_FIELD_DEF;
    ...
    public static final int ANNOTATIONS =
        GeneratedApexTokenTypes.ANNOTATIONS;
    ...
    public static final int ANNOTATION =
        GeneratedApexTokenTypes.ANNOTATION;
    ...
    public static final int ANNOTATION_MEMBER_VALUE_PAIR =
        GeneratedApexTokenTypes.ANNOTATION_MEMBER_VALUE_PAIR;
    ...
    public static final int ANNOTATION_ARRAY_INIT =
        GeneratedApexTokenTypes.ANNOTATION_ARRAY_INIT;
    ...
    public static final int TYPE_PARAMETERS =
        GeneratedApexTokenTypes.TYPE_PARAMETERS;
    ...
    public static final int TYPE_PARAMETER =
        GeneratedApexTokenTypes.TYPE_PARAMETER;
    ...
    public static final int TYPE_ARGUMENTS =
        GeneratedApexTokenTypes.TYPE_ARGUMENTS;
    ...
    public static final int TYPE_ARGUMENT =
        GeneratedApexTokenTypes.TYPE_ARGUMENT;
    ...
    public static final int WILDCARD_TYPE =
        GeneratedApexTokenTypes.WILDCARD_TYPE;
    ...
    public static final int TYPE_UPPER_BOUNDS =
        GeneratedApexTokenTypes.TYPE_UPPER_BOUNDS;
    ...
    public static final int TYPE_LOWER_BOUNDS =
        GeneratedApexTokenTypes.TYPE_LOWER_BOUNDS;
     ...
     * JSR201</a>
     */
    public static final int AT = GeneratedApexTokenTypes.AT;
     ...
     * JSR201</a>
     */
    public static final int ELLIPSIS = GeneratedApexTokenTypes.ELLIPSIS;
    ...
    public static final int TYPE_EXTENSION_AND =
        GeneratedApexTokenTypes.TYPE_EXTENSION_AND;
    ...
    public static final int GENERIC_START =
        GeneratedApexTokenTypes.GENERIC_START;

    /**
     * '&gt;' symbol signifying the end of type arguments or type parameters.
     */
    public static final int GENERIC_END = GeneratedApexTokenTypes.GENERIC_END;

    /**
     * Special lambda symbol '-&gt;'.
     */
    public static final int LAMBDA = GeneratedApexTokenTypes.LAMBDA;
    ...
    public static final int SINGLE_LINE_COMMENT =
            GeneratedApexTokenTypes.SINGLE_LINE_COMMENT;
    ...
    public static final int BLOCK_COMMENT_BEGIN =
            GeneratedApexTokenTypes.BLOCK_COMMENT_BEGIN;
    ...
    public static final int BLOCK_COMMENT_END =
            GeneratedApexTokenTypes.BLOCK_COMMENT_END;
    ...
    public static final int COMMENT_CONTENT =
            GeneratedApexTokenTypes.COMMENT_CONTENT;

    public static final int LITERAL_WITH =
        GeneratedApexTokenTypes.LITERAL_with;
    public static final int LITERAL_WITHOUT =
        GeneratedApexTokenTypes.LITERAL_without;
    public static final int LITERAL_SHARING =
        GeneratedApexTokenTypes.LITERAL_sharing;
    public static final int LITERAL_GLOBAL =
        GeneratedApexTokenTypes.LITERAL_global;
    public static final int LITERAL_WEBSERVICE =
        GeneratedApexTokenTypes.LITERAL_webservice;
